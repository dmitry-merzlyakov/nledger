...
namespace NLedger.IntegrationTests
{
    public class TestSet_test_regress
    {
        ...
        {
            new TestRunner(@"test/regress/4D9288AE_py.test").Run("python");
        }
        ...
        {
            new TestRunner(@"test/regress/78AB4B87_py.test").Run("python");
        }
        ...
        {
            new TestRunner(@"test/regress/9188F587_py.test").Run("python");
        }
        ...
        {
            new TestRunner(@"test/regress/B21BF389_py.test").Run("python");
        }
